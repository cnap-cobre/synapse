        ...
        <DefaultLayout>
          <div className="content">
            <div className="container-fluid">
              ...
              <Row>
                <Col md={12}>
                  <Card header={(<h3>File Systems</h3>)} hr={true}>
                    <FileSystemList />
                  </Card>
                </Col>
              </Row>
              ...
              <Row>
                <Col md={6}>
                  <Card header={(<h4>Add Common File Systems</h4>)} hr={true}>
                    <LinkBeocatButton/>
                  </Card>
                </Col>
                <Col md={6}>
                  <Card header={(<h4>Connect External File System</h4>)} hr={true}>
                    <LinkDropboxButton/>
                  </Card>
                </Col>
              </Row>
              ...
              <Row>
                <Col md={7}>
                  <Card header={(<h4>Add an SFTP File System</h4>)} hr={true}>
                    <AddSftpFileSystemForm/>
                  </Card>
                </Col>

                <Col md={5}>
                  <Card header={(<h4>System Adding Instructions</h4>)} hr={true}>
                    <h6>Overview</h6>
                    <p>
