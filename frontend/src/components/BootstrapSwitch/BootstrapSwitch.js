  ...
  render() {
    return (
      ...
      >
        ...
        >
          <span
            className={`bootstrap-switch-handle-on bootstrap-switch-${this.props.enabledColor}`}
            style={{
              width: '50px',
            }}
          >
          ...
          <span
            className={`bootstrap-switch-handle-off bootstrap-switch-${this.props.disabledColor}`}
            style={{
              width: '50px',
            }}
          >
